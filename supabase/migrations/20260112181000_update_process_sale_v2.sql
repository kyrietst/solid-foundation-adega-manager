-- Migration: Update process_sale to support Split Payments (JSONB Input)
-- Date: 2026-01-12
...
CREATE OR REPLACE FUNCTION public.process_sale(
    ...
    p_payments jsonb, -- NEW: Array of { method_id, amount, installments }
...
BEGIN
    ...
    -- This ensures old queries/dashboards don't break immediately
    v_item := p_payments->0; 
    ...
    -- Fallback to ensure not-null constraint is met (Default to 'other')

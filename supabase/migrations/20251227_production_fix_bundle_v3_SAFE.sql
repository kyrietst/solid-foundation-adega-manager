-- FINAL PRODUCTION BUNDLE V3 (SAFE VERSION)
...
-- 4. TUNE: Apply Supabase Advisor Index suggestions (Add FK Indexes ONLY).
--    REMOVED: Drop Unused Indexes (Unsafe for Production).
...
-- ALTER VIEW public.vw_kyrie_intelligence_margins SET (security_invoker = true); -- MISSING IN PROD

-- ============================================================================
-- Migration: FIX - Process Sale RPC Remove total_price (v6)
-- Data: 2026-01-03
-- Descrição: 
-- 1. Remove a coluna "total_price" do INSERT em "sale_items", pois ela não existe na tabela.
-- 2. Mantém a lógica de correção do payment_method da versão anterior.
-- ============================================================================
...
BEGIN
    ...
    LOOP
        ...
        -- CORREÇÃO: Removido 'total_price' que não existe na tabela sale_items
        INSERT INTO sale_items (
            sale_id,
            product_id,
            quantity,
            unit_price,
            -- total_price, REMOVIDO
            sale_type
        ) VALUES (
            v_sale_id,
            v_product_id,
            v_quantity,
            v_unit_price,
            -- (v_quantity * v_unit_price), REMOVIDO
            v_sale_type
        );

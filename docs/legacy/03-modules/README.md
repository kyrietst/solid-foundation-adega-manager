...
- **Funcionalidades**:
  ...
  - 🗑️ **Soft Delete System** (v3.3.4) - Exclusão segura com auditoria e restauração
- **Documentação Específica**:
  - 🔧 [Sistema de Códigos de Barras](./inventory/BARCODE_SYSTEM_GUIDE.md)
  - 🗑️ [Sistema de Soft Delete](./inventory/PRODUCT_SOFT_DELETE_SYSTEM.md)

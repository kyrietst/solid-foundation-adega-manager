...
import { ProfileCompletenessIndicator } from '@/features/customers/components/profile-completeness';
...
import { CustomerProfile, CustomerInsight, CustomerInteraction, CustomerPurchase, useProfileCompleteness, useUpsertCustomer, useAddCustomerInteraction } from '@/features/customers/hooks/use-crm';
import { useAuth } from '@/app/providers/AuthContext';
import { cn } from '@/core/config/utils';
import { useDeleteCustomerInteraction } from '@/features/customers/hooks/use-crm';
import { useProduct } from '@/features/inventory/hooks/use-product';
import { useCustomerTimeline } from '@/features/customers/hooks/use-crm';
import { useCustomerStats } from '@/features/customers/hooks/use-crm';
import { useCustomerPurchases } from '@/features/customers/hooks/use-crm';
                        ...
                        <table className="w-full text-sm">
                          <thead>
                            <tr className="text-xs text-muted-foreground">
                              <th scope="col" className="text-left pb-2">Produto</th>
                              <th scope="col" className="text-center pb-2">Qtd</th>
                              <th scope="col" className="text-right pb-2">Valor</th>
                            </tr>
                          </thead>
                          <tbody>

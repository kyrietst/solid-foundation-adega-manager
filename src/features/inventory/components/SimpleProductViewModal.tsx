    ...
    <Sheet open={isOpen} onOpenChange={(open) => !open && onClose()}>
      ...
      >
        <div className="h-full flex flex-col">
            ...
            {/* FOOTER (BARRA DE COMANDO) */}
            <div className="border-t border-white/5 bg-zinc-900/80 backdrop-blur-xl px-8 py-5 sticky bottom-0 z-50 flex items-center justify-between">
               <div className="hidden md:flex items-center gap-4 text-zinc-500 text-[10px] font-mono uppercase tracking-wider">
                  ...
                  <div>
                     SYNC: {product.updated_at ? new Date(product.updated_at).toLocaleTimeString() : 'N/A'}
                  </div>
               </div>
               ...
               <div className="flex items-center gap-3 w-full md:w-auto justify-end">
                  <Button 
                     ...
                     variant="outline"
                     className="h-12 border-zinc-700 text-zinc-400 hover:text-white hover:border-violet-500 hover:bg-violet-500/10 transition-all"
                  >
                  ...
                  <Button 
                     ...
                     variant="outline"
                     className="h-12 border-zinc-700 text-zinc-400 hover:text-white hover:border-amber-500 hover:bg-amber-500/10 transition-all"
                  >
                  ...
                  <Button 
                     ...
                     className="h-12 px-8 bg-emerald-600 hover:bg-emerald-500 text-white font-bold shadow-[0_0_20px_rgba(16,185,129,0.3)] border border-emerald-400/20"
                  >

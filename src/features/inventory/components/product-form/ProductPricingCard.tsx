    ...
    <Card className={cn(glassClasses, 'shadow-xl')}>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <Label htmlFor="margin_percent" className="text-gray-200">Margem (%) ou</Label>
            <Input
              id="margin_percent"
              type="number"
              step="0.01"
        ...
        {formData.is_package && (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <Label htmlFor="package_size" className="text-gray-200">Unidades por Pacote</Label>
            <Input
              id="package_size"
              type="number"
          ...
          <div>
            <Label htmlFor="package_price" className="text-gray-200">Preço de Venda (pct)</Label>
            <Input
              id="package_price"
              type="number"
              step="0.01"
